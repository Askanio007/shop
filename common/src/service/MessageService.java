...
public class MessageService {
	...
	// TODO: Artyom переделал, в сообщения записывается айди саппорта и айди покупателя.
	// Айди саппорта присваивается в тот момент, когда саппорт откроет чат с этим пользоаптелем в админке
	// но пока это не очень работает ))
